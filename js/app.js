(() => {
  ...
  window.addEventListener("load", function (e) {
    he(),
      document.querySelector(".titles__slider") &&
        new ce(".titles__slider", {
          modules: [ue],
          observer: !0,
          observeParents: !0,
          slidesPerView: 8,
          ...
          breakpoints: {
            ...
            466: { slidesPerView: 4, spaceBetween: 0 },
            600: { slidesPerView: 5, spaceBetween: 0 },
            768: { slidesPerView: 6, spaceBetween: 0 },
            992: { slidesPerView: 6, spaceBetween: 0 },
            1268: { slidesPerView: 8, spaceBetween: 0 },
          },
          on: {},
        }),
      document.querySelector(".category__slider") &&
        new ce(".category__slider", {
          modules: [pe, ue],
          observer: !0,
          observeParents: !0,
          slidesPerView: 4,
          ...
          loop: !0,
          breakpoints: {
            0: { slidesPerView: 1, spaceBetween: 16, autoHeight: !0 },
            600: { slidesPerView: 2, spaceBetween: 16 },
            992: { slidesPerView: 3, spaceBetween: 16 },
            1140: { slidesPerView: 4, spaceBetween: 16 },
            1268: { slidesPerView: 4, spaceBetween: 16 },
            1920: { slidesPerView: 6, spaceBetween: 16 },
            2500: { slidesPerView: 8, spaceBetween: 16 },
          },
          on: {},
        });
  });
  ...
  setTimeout(() => {
    ...
    (function () {
      ...
      window.innerWidth < 992
        ? e.setAttribute("data-sticky-header", "data-sticky-header")
        : document
            .querySelector("#catalog")
            .removeAttribute("data-sticky-header"),
        window.addEventListener("resize", function () {
          window.matchMedia("(max-width: 992px)").matches
            ? document
                .querySelector("#catalog")
                .setAttribute("data-sticky-header", "data-sticky-header")
